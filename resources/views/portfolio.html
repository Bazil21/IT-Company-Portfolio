...
<!-- Mirrored from templates.envytheme.com/togy/default/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:33 GMT -->
<head>
        <meta charset="UTF-8">
    ...
    <body>
                        ...
                        <div class="flex self-center grow basis-auto">
                            <ul class="self-center flex flex-row ml-auto mr-auto">
                                ...
                                <li class="ml-12 xl:ml-15 mr-12 xl:mr-15 relative group">
                                    ...
                                    <ul class="absolute bg-white left-0 w-[250px] rounded-sm top-84 z-99 shadow-dropdown pt-10 pb-10 opacity-0 invisible ease-in duration-300 group-hover:opacity-100 group-hover:visible">
                                        <li>
                                            <a href="portfolio.html" class="active block font-medium text-16px text-black-color ease-in duration-300 hover:text-primary-color pt-9 pb-9 pl-20 pr-20">Portfolio</a>
                                        </li>
                                        <li>
        ...
        <div class="relative z-1 text-center pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                <h1 class="font-black text-25px md:text-35px lg:text-40px xl:text-48px 2xl:text-54px text-black-color mb-8">Our <span class="text-primary-color">Portfolio</span></h1>
            ...
            <div class="left-0 top-25 absolute -z-1 hidden xl:inline"><img src="assets/img/shape/shape34.png" class="animate-custom-movebounce w-[100px]" alt="shape"></div>
                ...
                <div class="customer-service-tabs style-two">
                    ...
                    <div id="tab-1" class="tab-content current">
                        <div class="grid gap-30 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio1.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio2.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                        ...
                        <div class="grid mt-30 gap-30 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio3.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                                        Dashboard Design
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio4.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio5.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio6.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                                        Task Management App
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio7.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                                        Product Design
                            ...
                            <div class="relative">
                                <a href="portfolio-details.html" class="block">
                                    <img src="assets/img/portfolio/portfolio8.jpg" class="mb-25 rounded-sm md:rounded-md lg:rounded-lg" alt="portfolio-image">
                                </a>
                                <h3 class="font-bold text-18px md:text-20px lg:text-22px mb-10 lg:mb-12">
                                    <a href="portfolio-details.html" class="inline-block text-black-color hover:text-primary-color ease-in duration-300">
                                        Work Flow App
                    ...
                    <div class="single-footer-widget md:-ml-35">
                        ...
                        <ul>
                            ...
                            <li class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#2048454c4c4f60544f47590e434f4d" class="text-optional-color transition hover:text-secondary-color"><span class="__cf_email__" data-cfemail="c8a0ada4a4a788bca7afb1e6aba7a5">[email&#160;protected]</span></a>
                            </li>
                        </ul>
...
<!-- Mirrored from templates.envytheme.com/togy/default/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:34 GMT -->
</html> 