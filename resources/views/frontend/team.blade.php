...
<!-- Mirrored from templates.envytheme.com/togy/default/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:29 GMT -->
<head>
        <meta charset="UTF-8">
                            ...
                            <ul class="self-center flex flex-row ml-auto mr-auto">
                                ...
                                <li class="ml-12 xl:ml-15 mr-12 xl:mr-15 relative group">
                                    ...
                                    <ul class="absolute bg-white left-0 w-[250px] rounded-sm top-84 z-99 shadow-dropdown pt-10 pb-10 opacity-0 invisible ease-in duration-300 group-hover:opacity-100 group-hover:visible">
                                        ...
                                        <li>
                                            <a href="team.html" class="active block font-medium text-16px text-black-color ease-in duration-300 hover:text-primary-color pt-9 pb-9 pl-20 pr-20">Team</a>
                                        </li>
                                        <li class="relative">
                    ...
                    <div class="single-footer-widget md:-ml-35">
                        ...
                        <ul>
                            ...
                            <li class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#c0a8a5acacaf80b4afa7b9eea3afad" class="text-optional-color transition hover:text-secondary-color"><span class="__cf_email__" data-cfemail="7d15181111123d09121a04531e1210">[email&#160;protected]</span></a>
                            </li>
                        </ul>
...
<!-- Mirrored from templates.envytheme.com/togy/default/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:31 GMT -->
</html>