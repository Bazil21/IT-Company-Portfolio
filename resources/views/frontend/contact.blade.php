...
<!-- Mirrored from templates.envytheme.com/togy/default/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:37 GMT -->
<head>
        <meta charset="UTF-8">
    ...
    <body>
                            ...
                            <ul class="self-center flex flex-row ml-auto mr-auto">
                                <li class="mr-12 xl:mr-15 relative group">
                                    ...
                                    <ul class="absolute bg-white left-0 w-[250px] rounded-sm top-84 z-99 shadow-dropdown pt-10 pb-10 opacity-0 invisible ease-in duration-300 group-hover:opacity-100 group-hover:visible">
                                        <li>
                                            <a href="index.html" class="block font-medium text-16px text-black-color ease-in duration-300 hover:text-primary-color pt-9 pb-9 pl-20 pr-20">Project Management</a>
                                        </li>
                                        <li>
                                ...
                                <li class="ml-12 xl:ml-15">
                                    <a href="contact.html" class="active block text-black-color font-semibold text-16px ease-in duration-300 hover:text-primary-color pt-30 pb-30">Contact Us</a>
                                </li>
                            </ul>
            ...
            <div class="mean-menu">
                <ul class="navbar-nav">
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="index.html">Project Management</a>
                            </li>
                            <li>
        ...
        <div class="relative z-1 text-center pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                <h1 class="font-black text-25px md:text-35px lg:text-40px xl:text-48px 2xl:text-54px text-black-color mb-8">How To <span class="text-primary-color">Contact Us</span></h1>
        ...
        <div class="pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                <div class="grid gap-25 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    <div class="group text-center md:text-left pt-20 md:pt-30 lg:pt-40 pb-20 md:pb-30 lg:pb-40 pr-20 md:pr-30 lg:pr-40 pl-20 md:pl-30 lg:pl-40 xl:pl-[160px] bg-green-gradient-color relative rounded-md wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <div class="icon w-100 h-100 rounded-full bg-white-light text-center mb-20 xl:mb-0 relative xl:absolute xl:left-40 xl:top-1/2 xl:-translate-y-2/4 ease-in duration-300 group-hover:bg-white ml-auto mr-auto md:ml-0 md:mr-0">
                            <img src="assets/img/icon/callback.svg" class="w-70 absolute left-0 right-0 top-1/2 m-auto -translate-y-2/4" alt="callback">
                        </div>
                        <h3 class="font-bold text-18px md:text-20px lg:text-24px mb-10 lg:mb-15 text-white">Call Us</h3>
                        <a href="tel:+9903294263" class="block text-white mb-8 text-13px md:text-15px lg:text-16px">+990 329 4263</a>
                        <a href="tel:+9903236897" class="block text-white text-13px md:text-15px lg:text-16px">+990 323 6897</a>
                    </div>
                    <div class="group text-center md:text-left pt-20 md:pt-30 lg:pt-40 pb-20 md:pb-30 lg:pb-40 pr-20 md:pr-30 lg:pr-40 pl-20 md:pl-30 lg:pl-40 xl:pl-[160px] bg-secondary-gradient-color relative rounded-md wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <div class="icon w-100 h-100 rounded-full bg-white-light text-center mb-20 xl:mb-0 relative xl:absolute xl:left-40 xl:top-1/2 xl:-translate-y-2/4 ease-in duration-300 group-hover:bg-white ml-auto mr-auto md:ml-0 md:mr-0">
                            <img src="assets/img/icon/workflow.svg" class="w-70 absolute left-0 right-0 top-1/2 m-auto -translate-y-2/4" alt="workflow">
                        </div>
                        <h3 class="font-bold text-18px md:text-20px lg:text-24px mb-10 lg:mb-15 text-white">Mail Us</h3>
                        <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#137b767f7f7c53677c746a3d707c7e" class="block text-white mb-8 text-13px md:text-15px lg:text-16px"><span class="__cf_email__" data-cfemail="6a020f0606052a1e050d1344090507">[email&#160;protected]</span></a>
                        <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#345d5a525b74405b534d1a575b59" class="block text-white text-13px md:text-15px lg:text-16px"><span class="__cf_email__" data-cfemail="b8d1d6ded7f8ccd7dfc196dbd7d5">[email&#160;protected]</span></a>
                    </div>
                    <div class="group text-center md:text-left pt-20 md:pt-30 lg:pt-40 pb-20 md:pb-30 lg:pb-40 pr-20 md:pr-30 lg:pr-40 pl-20 md:pl-30 lg:pl-40 xl:pl-[160px] bg-primary-gradient-color relative rounded-md wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <div class="icon w-100 h-100 rounded-full bg-white-light text-center mb-20 xl:mb-0 relative xl:absolute xl:left-40 xl:top-1/2 xl:-translate-y-2/4 ease-in duration-300 group-hover:bg-white ml-auto mr-auto md:ml-0 md:mr-0">
                            <img src="assets/img/icon/ticket.svg" class="w-70 absolute left-0 right-0 top-1/2 m-auto -translate-y-2/4" alt="ticket">
                        </div>
                        <h3 class="font-bold text-18px md:text-20px lg:text-24px mb-10 lg:mb-15 text-white">Visit Us</h3>
                        <a href="tel:+9903294263" class="block text-white mb-8 text-13px md:text-15px lg:text-16px" target="_blank">711-2880 Nulla St. Mankato Mississippi.</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                <div class="grid gap-25 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
                    <div class="xl:pr-15">
                        <h2 class="font-black text-22px md:text-30px lg:text-35px xl:text-38px mb-25 lg:mb-35 text-black-color">Send Us Message At Anytime From Anywhere </h2>
                        <form>
                            <div class="grid gap-20 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                                <input type="text" placeholder="Your Name" class="block w-full text-black-color bg-[#F5F0E8] h-50 lg:h-60 leading-[50px] lg:leading-[60px] rounded-sm pl-15 pr-15 placeholder:text-optional-color outline-0 placeholder:ease-in placeholder:duration-300 focus:placeholder:text-transparent text-13px md:text-15px lg:text-16px">
                                <input type="email" placeholder="Your Email" class="block w-full text-black-color bg-[#F5F0E8] h-50 lg:h-60 leading-[50px] lg:leading-[60px] rounded-sm pl-15 pr-15 placeholder:text-optional-color outline-0 placeholder:ease-in placeholder:duration-300 focus:placeholder:text-transparent text-13px md:text-15px lg:text-16px">
                                <input type="text" placeholder="Website" class="block w-full text-black-color bg-[#F5F0E8] h-50 lg:h-60 leading-[50px] lg:leading-[60px] rounded-sm pl-15 pr-15 placeholder:text-optional-color outline-0 placeholder:ease-in placeholder:duration-300 focus:placeholder:text-transparent text-13px md:text-15px lg:text-16px">
                                <input type="text" placeholder="Phone No" class="block w-full text-black-color bg-[#F5F0E8] h-50 lg:h-60 leading-[50px] lg:leading-[60px] rounded-sm pl-15 pr-15 placeholder:text-optional-color outline-0 placeholder:ease-in placeholder:duration-300 focus:placeholder:text-transparent text-13px md:text-15px lg:text-16px">
                            </div>
                            <textarea cols="30" rows="5" class="mt-20 block w-full text-black-color bg-[#F5F0E8] rounded-sm p-15 placeholder:text-optional-color outline-0 placeholder:ease-in placeholder:duration-300 focus:placeholder:text-transparent text-13px md:text-15px lg:text-16px" placeholder="Your message here..."></textarea>
                            <button type="submit" class="inline-block font-semibold text-13px md:text-14px lg:text-15px mt-15 md:mt-25 rounded-sm text-white pt-17 pb-13 pl-35 pr-35 bg-gradient-color shadow-custom-box-shadow hover:shadow-primary-btn ease-in duration-300">Send Message</button>
                        </form>
                    </div>
                    <div class="xl:pl-15">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d91534.1660529877!2d-94.00799461643884!3d44.1979480980849!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87f439ec9c37e42f%3A0xfa189ddbeafb505e!2sBlue%20Earth%20County%20Historical%20Society!5e0!3m2!1sen!2sbd!4v1646287410772!5m2!1sen!2sbd" loading="lazy" class="w-full h-[450px] lg:h-full rounded-sm lg:rounded-lg"></iframe>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-footer-widget md:-ml-35">
                        ...
                        <ul>
                            ...
                            <li class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#b3dbd6dfdfdcf3c7dcd4ca9dd0dcde" class="text-optional-color transition hover:text-secondary-color"><span class="__cf_email__" data-cfemail="5038353c3c3f10243f37297e333f3d">[email&#160;protected]</span></a>
                            </li>
                        </ul>
