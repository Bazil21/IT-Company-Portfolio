...
<!-- Mirrored from templates.envytheme.com/togy/default/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:32 GMT -->
<head>
        <meta charset="UTF-8">
                        ...
                        <div class="flex self-center grow basis-auto">
                            <ul class="self-center flex flex-row ml-auto mr-auto">
                                ...
                                <li class="ml-12 xl:ml-15 mr-12 xl:mr-15 relative group">
                                    ...
                                    <ul class="absolute bg-white left-0 w-[250px] rounded-sm top-84 z-99 shadow-dropdown pt-10 pb-10 opacity-0 invisible ease-in duration-300 group-hover:opacity-100 group-hover:visible">
                                        <li>
                                            <a href="services.html" class="active block font-medium text-16px text-black-color ease-in duration-300 hover:text-primary-color pt-9 pb-9 pl-20 pr-20">Services</a>
                                        </li>
                                        <li>
                    ...
                    <div class="single-footer-widget md:-ml-35">
                        ...
                        <ul>
                            ...
                            <li class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#2e464b4242416e5a414957004d4143" class="text-optional-color transition hover:text-secondary-color"><span class="__cf_email__" data-cfemail="8de5e8e1e1e2cdf9e2eaf4a3eee2e0">[email&#160;protected]</span></a>
                            </li>
                        </ul>
