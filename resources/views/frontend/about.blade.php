...
<!-- Mirrored from templates.envytheme.com/togy/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 May 2023 05:23:29 GMT -->
<head>
        <meta charset="UTF-8">
    ...
    <body>
                        ...
                        <div class="flex self-center grow basis-auto">
                            <ul class="self-center flex flex-row ml-auto mr-auto">
                                ...
                                <li class="ml-12 xl:ml-15 mr-12 xl:mr-15 relative group">
                                    <a href="#" class="active block text-black-color font-semibold text-16px ease-in duration-300 relative pr-15 before:absolute before:right-6 before:top-38 before:w-1 before:h-9 before:bg-black-color before:-rotate-45 before:ease-in before:duration-300 after:absolute after:right-0 after:top-38 after:w-1 after:h-9 after:bg-black-color after:rotate-45 after:ease-in after:duration-300 hover:text-primary-color hover:before:bg-primary-color hover:after:bg-primary-color pt-30 pb-30">Pages</a>
                                    <ul class="absolute bg-white left-0 w-[250px] rounded-sm top-84 z-99 shadow-dropdown pt-10 pb-10 opacity-0 invisible ease-in duration-300 group-hover:opacity-100 group-hover:visible">
                                        <li>
                                            <a href="about.html" class="active block font-medium text-16px text-black-color ease-in duration-300 hover:text-primary-color pt-9 pb-9 pl-20 pr-20">About Us</a>
                                        </li>
                                        <li>
        ...
        <div class="relative z-1 pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                <div class="text-center xl:ml-auto xl:mr-auto xl:max-w-[1115px]">
                    <h1 class="font-black text-25px md:text-35px lg:text-40px xl:text-48px 2xl:text-54px text-black-color mb-8">Little More <span class="text-primary-color">About Us</span></h1>
        ...
        <!-- Features Area -->
        <div class="features-area pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100 bg-[#fbfbfb] relative z-1">
            <div class="container">
                <div class="grid gap-25 grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="content xl:pl-[100px] self-center">
                        ...
                        <h2 class="font-black text-22px md:text-28px lg:text-35px xl:text-40px mb-12 text-black-color">We Help To Move Forward Teams Work</h2>
                        <p class="text-13px md:text-15px lg:text-16px leading-7 md:leading-8 text-optional-color">Lorem ipsum dolor sit amet, consectetur adipis elit. Nulla imperdiet nulla duis ac. Id massa scelerisque ven enatis, massa gravida donec orci.</p>
        ...
        <!-- Why We Are Best Area -->
        <div class="pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100 z-1 relative">
            <div class="container">
                <div class="section-title mb-35 md:mb-40 lg:mb-50 text-center">
                    <h2 class="font-black text-22px md:text-30px lg:text-35px xl:text-40px mb-6 text-black-color">Why We Are Best</h2>
                    <p class="lg:text-16px md:text-15px text-13px lg:max-w-2xl lg:mx-auto leading-7 md:leading-8 text-optional-color">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla imperdiet nulla duis ac. Id massa scelerisque venenatis, massa gravida donec orci.</p>
                </div>
                ...
                <div class="text-center mt-25 md:mt-30 md:ml-auto md:mr-auto md:max-w-[545px]">
        ...
        <div class="feedback-area relative z-2 pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100 bg-[#fcfcfc] bg-cover bg-no-repeat bg-center" style="background-image: url(assets/img/shape/bg6.jpg);">
            <div class="container">
                <div class="text-center md:text-left section-title mb-35 md:mb-40 lg:mb-50 relative">
                    ...
                    <h2 class="font-black text-22px md:text-30px lg:text-35px xl:text-40px text-black-color md:max-w-[400px]">Loved By Industry Leaders</h2>
                    <div class="mt-20 md:mt-0 md:absolute md:right-0 md:top-1/2 md:m-auto md:-translate-y-2/4">
                        <div class="customOne swiper-button-prev relative left-0 right-0 mt-0 w-42 md:w-50 bg-white shadow-custom-box-shadow3 rounded-sm opacity-100 h-42 md:h-50 top-0 inline-block after:hidden hover:bg-secondary-gradient-color">
                        ...
                        <div class="customTwo swiper-button-next relative left-0 right-0 mt-0 w-42 md:w-50 bg-white ml-8 shadow-custom-box-shadow3 rounded-sm h-42 md:h-50 top-0 inline-block after:hidden hover:bg-secondary-gradient-color">
            ...
            <div class="swiper feedbackSwiperSlides -mb-20 pl-15 pr-15 md:pl-0 md:pr-0">
        ...
        <!-- Feedback Area -->
        <div class="feedback-area relative z-1 pt-60 md:pt-80 lg:pt-100 pb-60 md:pb-80 lg:pb-100">
            <div class="container">
                    ...
                    <div class="single-footer-widget md:-ml-35">
                        ...
                        <ul>
                            ...
                            <li class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#7b131e1717143b0f141c0255181416" class="text-optional-color transition hover:text-secondary-color"><span class="__cf_email__" data-cfemail="89e1ece5e5e6c9fde6eef0a7eae6e4">[email&#160;protected]</span></a>
                            </li>
                        </ul>
