                        ...
                        <ul>
                            <li
                                ...
                                <a href="tel:+(323)750-1234"
                                    class="text-optional-color transition hover:text-secondary-color">+(323)
                                    750-1234</a>
                            </li>
                            <li
                                class="mb-15 md:mb-15 lg:mb-20 text-optional-color last:mb-0 relative text-13px md:text-15px lg:text-16px pl-25">
                                ...
                                <a href="#" target="_blank"
                                    class="text-optional-color transition hover:text-secondary-color">+7011 Vermont Ave,
                            ...
                            <li
                                ...
                                <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#8be3eee7e7e4cbffe4ecf2a5e8e4e6"
                                    class="text-optional-color transition hover:text-secondary-color"><span
                                        class="__cf_email__"
                                        data-cfemail="3a525f5656557a4e555d4314595557">[email&#160;protected]</span></a>
                            </li>
                        </ul>
        ...
        <div class="copyright-area pt-25 md:pt-35 pb-25 md:pb-35 text-center lg:text-left">
            <div class="container">
                <div
                    ...
                    <div class="copyright">
                        <p class="text-13px md:text-15px lg:text-16px text-optional-color">&copy;2022 <span
                                class="font-semibold text-primary-color">Togy</span>. All rights reserved by <a
                                href="https://envytheme.com/" class="font-semibold bg-primary-gradient-color"
                        ...
                        <ul class="lg:text-right">
                            <li class="inline-block mr-15 md:mr-20 lg:mr-25 last:mr-0 mt-10 md:mt-0">
                                <a href="privacy-policy.html"
                                    class="inline-block text-optional-color text-13px md:text-15px lg:text-16px transition hover:text-secondary-color">
                                    Privacy Policy
                                </a>
                            </li>
                            <li class="inline-block mr-15 md:mr-20 lg:mr-25 last:mr-0 mt-10 md:mt-0">
